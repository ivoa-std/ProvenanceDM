...
This VOTABLE serialisation can be considered as a flat view on the various tables stored in a database implementing the datamodel structure explained in section \ref{sec:datamodel} 
More examples of serialisation documents are provided in Appendix A \ref{{sec:appendixA}}. 
