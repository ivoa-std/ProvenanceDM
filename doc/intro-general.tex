...
The provenance of scientific data is related to the FAIR principles for data sharing \citep{FAIR-principles} and corresponds to relevant information in the context of openly published science data.
