...
sufficiently abstract that its core pattern could be applied to any kind of process using either observation or simulation data. It could also be used to describe the workflow for observaton proposals or the publication of scientific articles based on (astronomical) data. 
The links between the Provenance Data Model and other IVOA data models 
will be discussed in Section~\ref{sec:dmlinks}.
...
They can be included in the form of additional data linked to observations, or as attributes of observation processes.
...
is adequate for his/her research goal, assess its quality and get enough information
