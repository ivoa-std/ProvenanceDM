...
"SELECT * FROM  Entity WHERE e\_ed\_ref = 'hispgen\_id""
\item To retrieve all activities associated with agent "obspm": \\
"SELECT WasAssociatedWith.as\_a\_id, Activity.a\_name, Activity.a\_annotation FROM WasAssociatedWith INNER JOIN Activity ON WasAssociatedWith.as\_a\_id = Activity.a\_id WHERE  WasAssociatedWith.as\_ag\_id = 'obspm'"
\item To retrieve all "curator" agents: \\
"SELECT  WasAttributedTo.at\_e\_id FROM WasAttributedTo WHERE WasAttributedTo.at\_ag\_role = 'curator'"
\end{itemize}
