...
\begin{figure}[hbt]
\centering
\includegraphics[width=1.0\textwidth]{PROV_WD_ActivityConfiguration.png}
...
default     & string & the default value of the entity as a string whose value can be interpreted by the \attribute{valueType} attribute \\
\bottomrule
\end{tabulary}
...
\tymax  0.5\textwidth
 ...
 \midrule
%\textbf{id}   & string            & a unique id\\
\textbf{artefactType} &  string & takes the value "Parameter" or "ConfigFile" (TypeOfConfigArtefact enumeration in the diagram) to indicate the type of class pointed by the \class{WasConfiguredBy} instance. \\
\bottomrule
\end{tabulary}
