...
\item \class{WasInformedBy} and \class{WasDerivedFrom} are optional and included in section \ref{sec:entity-activity-relations} on Entity-Activity relations. They are simple relations.
\item Addition of \class{ValueEntity} and \class{DatasetEntity} (with their description classes) as specific types of Entity classes (section \ref{sec:spec_entities}).
