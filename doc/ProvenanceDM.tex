...
binding to the Cerenkov Telescope Array (CTA) project, Markus Demleitner and
Markus Nullmeier for interaction with GAVO, Harry Enke, Jochen Klar, Gerard
Lemson, Laurent Michel for the VODML expression of the data model, Ole
Streicher, Anastasia Galkin and Adrian Partl for the IAP support for this
specification.
