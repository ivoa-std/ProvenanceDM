...
% --> Moved to ProvDAL document or Provenance Access
%\label{sec:provaccess}
%\input{provaccess}


%\section{Use cases -- applying the data model}
% --> moved to Implementation Note
...
%\section{VOTable serialisation of Provenance metadata and ProvTAP TAP schema}
...
\item Moved ProvTAP section and PROV-VOTable serialisation to separate ProvTAP document.
