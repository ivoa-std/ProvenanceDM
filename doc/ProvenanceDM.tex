...
\item Renamed Section~\ref{sec:usecases-implementations} to stress that it explains applications of the model (use cases); implementation details can be found in Implementation Note \citep{std:ProvenanceImplementationNote}.
