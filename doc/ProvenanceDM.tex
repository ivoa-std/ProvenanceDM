...
\previousversion[https://wiki.ivoa.net/internal/IVOA/ObservationProvenanceDataModel/Provenance\_WD2.pdf]{WD-ProvenanceDM-1.0-20190614.pdf}
...
\begin{figure}[ht]
\centering
%\includegraphics[width=1.26\textwidth]{2019-05-27_detailedView.png}
% Mireille: je suggere de mettre ce nouveau diagramme avec les bonnes multiplicités d attributs / a confirmer Mathieu si ok 
\hspace*{-.13\textwidth} 
