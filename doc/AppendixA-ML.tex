...
The Prov-N format \cite{std:PROV-N} as proposed by the W3C is a text format which allows the description of instances of the main 3 classes, as well as the various relations between each instance involved.
...
\begin{lstlisting}[language=C, caption= JSON serialisation example for a Color composition Activity]]
{
  "prefix": {
