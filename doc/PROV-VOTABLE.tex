...
Table \ref{table:entityTab} to \ref{table:WasAttributedToTab} provide full description of the FIELDS of  each of the mapping tables. The content of all these tables columns is normative.
